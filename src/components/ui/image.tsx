...
export const GeminiImage = ({ url }: { url: string | undefined }) => (
  <>
    {url ? (
      <AIMessageComponent>
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200/50 shadow-lg backdrop-blur-sm max-w-md">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Created with Gemini</p>
              </div>
            </div>
